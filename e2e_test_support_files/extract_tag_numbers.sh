#obtenido de: https://github.com/openmrs/openmrs-distro-referenceapplication/blob/main/e2e_test_support_files/extract_tag_numbers.sh
#por editar segun sea necesario
#!/bin/bash
...
#definir modulos clave para el flujo e2e??
